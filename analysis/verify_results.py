...
CHECKS = [
    ...
    ("placement bound relocated",
     "| across-road bound | 40.8 m | **33.0 m** | **-19.1 percent** |",
     "campaign_offset_rsu/logs/geometry_bound",
     "across the road                33.0 m"),
    ("placement bound centreline matched",
     "| **anisotropy** | **3.1** | **2.4** | |",
     "campaign_gnss/logs/geometry_bound_3seed",
     "across the road                40.8 m"),
    ("placement estimator unmoved",
     "| free fit localisation error, measured | 65.3 m | **66.6 m** |",
     "campaign_offset_rsu/logs/br_offset_free",
     "free-fit localisation error on these benign triples: median 66.6 m"),
    ("federated drift reverse direction",
     "| **trained on the target density** | 477 | 201,964 | **0.3205 +/- 0.0205** | **0.4363** |",
     "drift/logs/federated_drift_sparse",
     "in-dist       477 clients  201,964 rows   macro F1 0.3205 +/- 0.0205"),
    # 3h3, the estimator study
    ("estimator baseline reproduces free",
     "| ordinary least squares, what the project uses | 64.8 m | 18.1 m |",
     "campaign_gnss/logs/estimator_study_heldout",
     "ols, what the project uses              64.8 m"),
    ("estimator debiased and weighted",
     "| **calibrated mean removed and weighted** | **20.1 m** | **12.8 m** |",
     "campaign_gnss/logs/estimator_study_heldout",
     "debiased and weighted                   20.1 m"),
    ("estimator road constrained gain",
     "and the road\nconstrained fit by 30 percent",
     "campaign_gnss/logs/estimator_study_heldout_road",
